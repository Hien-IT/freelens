  ...
  instantiate: () => {
    const theme: LensTheme = {
      ...
      colors: {
        ...
        buttonPrimaryBackground: "#09a183",
        ...
        drawerItemValueColor: "#dadada",
        clusterMenuBackground: "#181a1c",
